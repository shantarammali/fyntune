            ...
            <div class="col-sm-offset-3 col-md-6">
              ...
              <div class="">
               ...
               if ($this->session->flashdata('success')) {
                ...
                <!-- form start -->
                <?php echo form_open('user/signup',['class'=>'form-horizontal','id'=>'loginForm']);?>
                <div class="box-body"> 
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          ...
                          <?php echo form_error('address','<div class="error" style="color:red">','</div>');?>
            					...
            					<div class="form-group">
                                  <?php echo form_label('confirm password','',['class'=>"col-sm-2 control-label"]);
            							echo form_password('confirm_password','','class="form-control" placeholder="confirm password"');?>
            							<?php echo form_error('confirm_password','<div class="error" style="color:red">','</div>');?>
                      </div>	

          				    <div class="box-footer">
                              <?php echo form_submit('submit','submit','class="btn btn-primary"'); ?>
                               <?php echo anchor(base_url().'user/login','Login','class="btn btn-info pull-right"'); ?>
